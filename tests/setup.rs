...
where
    ObjBuilder: 'static + Copy + Fn() -> autofaucet::ContractObj<DebugApi>,
{
    pub blockchain: BlockchainStateWrapper,
    pub owner_address: Address,
    pub user_address: Address,
    pub resolver_address: Address,
    pub contract: ContractObjWrapper<autofaucet::ContractObj<DebugApi>, ObjBuilder>,
}
...
fn it_initializes_the_contract() {
    let mut setup = Setup::new(autofaucet::contract_obj);
